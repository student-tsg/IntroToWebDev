...
// If kidsWhoWantToSwim is odd, then at least one kid doesn't have a swimming buddy. To avoid leaving 
// anyone out, we'll just do archery that afternoon.
...
// If it's even, n % 2 will be zero because there's no remainder when an even number is divided by 2.
// ------------------------

// Write your code here:

// When you're finished, open index.html with your browser (the HTML file that references this JavaScript).
// Open the JavaScript console in your browser's developer tools.
// Confirm there are no errors.
// Confirm that totals are correct.
// If there's trouble, double-check your code, make fixes, and reload the page.
